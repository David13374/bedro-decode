...
class BlueScoreSide : OpMode() {
    private val startPos = Pose(26.0,130.0, Math.toRadians(145.0))
    private val forwardPos = Pose(36.5, 121.79, Math.toRadians(145.0))
    private val parkPos = Pose(24.0, 96.6, Math.toRadians(-90.0))
